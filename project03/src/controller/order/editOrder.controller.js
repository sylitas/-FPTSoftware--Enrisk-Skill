...
/**
 * @api {put} /order 3 - Edit a order
 * @apiName editOrder
 * @apiGroup Order
 *
 * @apiHeader {String} Authorization Token of user after signIn
 *
 * @apiBody {Array} additional the information of products that client want to buy.
 * @apiBody {Array} removal the information of products that client want to remove from order.
 *
